...
(function () {
  ...
  // @isLeader
  // @type
  Pictionary.PlayerModel = Backbone.Model.extend({
    url: '/player',
  ...
  if (isServer) {
    exports.PlayerModel       = Pictionary.PlayerModel;
    exports.PlayersCollection = Pictionary.PlayersCollection;
  }
})();
